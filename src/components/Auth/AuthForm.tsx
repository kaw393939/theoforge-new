            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <EnvelopeIcon className="h-5 w-5 text-black/60 group-focus-within:text-primary" />
                </div>
                <input
                  type="email"
                  placeholder="Email"
                  className="w-full p-3 pl-10 border border-input bg-white/80 rounded-lg focus:ring-2 focus:ring-primary focus:outline-none transition-all duration-300 font-sans shadow-sm text-black placeholder:text-black/60"
                  value={email}
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <LockClosedIcon className="h-5 w-5 text-gray-400 group-focus-within:text-primary" />
                </div>
                <input
                  type="password"
                  placeholder="Password"
                  className="w-full p-3 pl-10 border border-input bg-white/80 rounded-lg focus:ring-2 focus:ring-primary focus:outline-none transition-all duration-300 font-sans shadow-sm"
                  value={password}
                ...
                <>
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className={`w-full p-3 pl-10 border ${password === confirmPassword ? "border-input" : "border-red-500"} bg-white/80 rounded-lg focus:ring-2 focus:ring-primary focus:outline-none transition-all duration-300 font-sans shadow-sm`}
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <UserIcon className="h-5 w-5 text-gray-400 group-focus-within:text-primary" />
                    </div>
                    <input
                      type="text"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="relative group">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <IdentificationIcon className="h-5 w-5 text-gray-400 group-focus-within:text-primary" />
                      </div>
                      <input
                        type="text"
