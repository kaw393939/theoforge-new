...
import PhilosopherChatPanel from '@/components/Graph/panels/PhilosopherChatPanel';
//import DynamicPhilosopherGraph from '@/components/Graph/EnterprisePhilosopherGraph'
...
export default function PhilosopherGraphPage({ characters }: { characters: CharacterData[] }) { 
